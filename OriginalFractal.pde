...
{
	background(colo);
	bezierSwirl(width/2, height/2, 0, PI/4, 250);
	bezierSwirl(width/2, height/2, 0, 3*PI/4, 250);
	bezierSwirl(width/2, height/2, 0, 5*PI/4, 250);
	bezierSwirl(width/2, height/2, 0, 7*PI/4, 250);
	colo += transition;
	if(colo >= 255)
		transition = -5;
	else if(colo <= 0)
